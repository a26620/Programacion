package com.example.loginandroid_29_09_2023.list_obra.model;
...
public class ListObraModel implements ContractListObra.Model {
    ...
    @Override
    public void listObraAPI(int id,OnListObraListener onListObraListener) {
        // Crear una instancia de ApiService
        ApiService apiService = RetrofitCliente.getClient("http://" + IP_BASE + "/untitled/").
                create(ApiService.class);

        // Realizar la solicitud al Servlet
        Call<DataObras> call = apiService.listObras("OBRA.LIST",id);
        call.enqueue(new Callback<DataObras>() {
            ...
            public void onResponse(Call<DataObras> call, Response<DataObras> response) {
                if (response.isSuccessful()) {
                    ...
                    try {
                        onListObraListener.onFinished(listObras);
