...
public class listaFilterObra extends RecyclerView.Adapter<listaFilterObra.ObraViewHolder> {

    ArrayList<Obra> lstObra;
    Context context;


    public listaFilterObra(ArrayList<Obra> lstObra) {
        this.lstObra = lstObra;
    }

    @NonNull
    @Override
    public listaFilterObra.ObraViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        context = parent.getContext();
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder_obrafilter,null,false);
        return new listaFilterObra.ObraViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull listaFilterObra.ObraViewHolder holder, int position) {
