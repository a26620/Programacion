package com.example.loginandroid_29_09_2023.ficha_descriptiva.model;
...
public class FichaDescriptivaModel implements ContractFichaDescriptiva.Model {
    //private static final String IP_BASE = "192.168.104.77:8080";
    private static final String IP_BASE = "192.168.1.48:8080";
    private FichaDescriptivaPresenter presenter;

    public FichaDescriptivaModel(FichaDescriptivaPresenter presenter) {
        this.presenter = presenter;
    }

    @Override
    public void fichaDescriptivaAPI(int id_usuario,OnFichaDescriptivaListener onFichaDescriptivaListener) {
        // Crear una instancia de ApiService
        ApiService apiService = RetrofitCliente.getClient("http://" + IP_BASE + "/untitled/").
                create(ApiService.class);

        // Realizar la solicitud al Servlet
        Call<DataObras> call = apiService.fichaDescriptiva("OBRA.FICHADESCRIPTIVA",id_usuario);
        call.enqueue(new Callback<DataObras>() {
            ...
            public void onResponse(Call<DataObras> call, Response<DataObras> response) {
                if (response.isSuccessful()) {
                    ...
                    try {
                        onFichaDescriptivaListener.onFinished(listObras.get(0));
